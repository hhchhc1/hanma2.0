...
/* Kconfig bug workaround: for ESP32-P4 + ESP32-C6 slave, Kconfig may fail
   to resolve the SLAVE_IDF_TARGET choice. Force ESP32-C6 when IDF_TARGET is P4. */
#if defined(CONFIG_IDF_TARGET_ESP32P4) && !defined(CONFIG_SLAVE_IDF_TARGET_ESP32) && !defined(CONFIG_SLAVE_IDF_TARGET_ESP32C6)
#define CONFIG_SLAVE_IDF_TARGET_ESP32C6 1
#ifndef CONFIG_ESP_HOSTED_SPI_CLK_FREQ
#define CONFIG_ESP_HOSTED_SPI_CLK_FREQ 40
#endif
#ifndef CONFIG_ESP_HOSTED_SPI_FREQ_ESP32C6
