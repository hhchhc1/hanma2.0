...
public:
    ...
    void AnnounceReminder();
    void SetReminder(int seconds);
    int GetRemaining() const { return reminder_remaining_; }
    int GetTotal() const { return reminder_total_; }
    void OnChatMessage(std::function<void(const std::string& role, const std::string& text)> callback);
